    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100, null=True, verbose_name='태그 이름')),
                ('order', models.IntegerField(blank=True, null=True, verbose_name='순서')),
            ],
            options={
                'verbose_name': '클럽 태그',
                'verbose_name_plural': '클럽 태그',
                'db_table': 'club_tags',
            },
