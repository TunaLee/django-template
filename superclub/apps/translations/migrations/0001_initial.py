    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ko', models.TextField(blank=True, null=True, verbose_name='한국어')),
                ('en', models.TextField(blank=True, null=True, verbose_name='영어')),
                ('ja', models.TextField(blank=True, null=True, verbose_name='일본어')),
                ('zh', models.TextField(blank=True, null=True, verbose_name='중국어')),
            ],
            options={
                'verbose_name': '번역',
